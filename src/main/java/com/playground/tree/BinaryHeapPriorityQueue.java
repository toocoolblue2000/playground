...
/*
https://www.udemy.com/course/introduction-to-data-structures/learn/lecture/7261030#overview
section 6
 */
public class BinaryHeapPriorityQueue<T extends Comparable<T>> {
    ...
    public BinaryHeapPriorityQueue(T[] elems) {
        ...
        // Heapify process, O(n)
        for (int i = Math.max(0, (heapSize / 2) - 1); i >= 0; i--) bubbleDown(i);
    }
    ...
    private T removeAt(int i) {
        ...
        if (heap.get(i).equals(elem)) bubbleUp(i);
        return removed_data;
    }
    ...
    public boolean isValidMinHeap(int k) {
        ...
        return isValidMinHeap(left) && isValidMinHeap(right);
    }
